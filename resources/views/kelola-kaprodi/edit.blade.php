        ...
        <form action="{{ route('updateUser', ['tipe' => 'kaprodi', 'username' => $kaprodi->username]) }}" method="POST"
            ...
            <div>
                ...
                <select id="id_prodi" name="id_prodi" required
                    ...
                    <option value="2" {{ $kaprodi->id_prodi == '2' ? 'selected' : '' }}>Teknik Informatika</option>
                    <option value="3" {{ $kaprodi->id_prodi == '3' ? 'selected' : '' }}>Sistem Informasi</option>
                    <option value="4" {{ $kaprodi->id_prodi == '4' ? 'selected' : '' }}>Magister Ilmu Komputer</option>
                </select>
            </div>
