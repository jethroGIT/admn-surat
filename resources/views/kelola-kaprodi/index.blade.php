    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            <div class="mb-4 md:mb-0">
                <h1 class="text-3xl font-bold text-indigo-800">Kelola Data Kepala Program Studi</h1>
                <p class="text-gray-600">Manajemen data Kepala Program Studi</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            @if ($users->count() == 0)
                <div class="p-8 text-center">
                    ...
                    <p class="mt-1 text-gray-500">Tidak ada data kaprodi yang sesuai dengan pencarian Anda.</p>
                </div>
            @else
