    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            <div class="mb-4 md:mb-0">
                <h1 class="text-3xl font-bold text-indigo-800">Manajemen Data Akun Kepala Program Studi</h1>
                <p class="text-gray-600">Sistem pengelolaan data untuk Kepala Program Studi</p>
            </div>
            
            <a href="{{ route('createUser', ['tipe' => 'kaprodi']) }}" 
            ...
            @if ($users->count() == 0)
                <div class="p-8 text-center">
                    ...
                    <p class="mt-1 text-gray-500">
                        @if(request()->has('search'))
                            Tidak ada data kaprodi yang sesuai dengan pencarian Anda.
                        @else
                            Silakan tambahkan data kaprodi dengan menekan tombol "Buat Akun" di atas.
                        @endif
                    </p>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-4">
                                            <a href="{{ route('showUser', ['tipe' => 'kaprodi', 'username' => $user->username]) }}" 
                                            ...
                                            <form id="delete-form-{{ $user->username }}"
                                                action="{{ route('destroyUser', ['tipe' => 'kaprodi', 'username' => $user->username]) }}"
