...
<head>
  ...
  <title>Dashboard Kaprodi - Pengajuan Surat</title>
      ...
      <div class="bg-white p-4 rounded-lg shadow border-l-4 border-purple-500">
        <div class="flex justify-between">
          <div>
            ...
            <h2 class="text-2xl font-bold">15 <span class="text-sm font-normal text-red-600">(7 baru)</span></h2>
          </div>
    ...
    <div class="mb-6 border-b border-gray-200">
      <ul class="flex flex-wrap -mb-px" id="suratTabs">
        <li class="mr-2" data-tab="keterangan-aktif">
          <button class="inline-block p-4 border-b-2 border-blue-500 text-blue-600 font-medium">Keterangan Aktif</button>
        </li>
        <li class="mr-2" data-tab="keterangan-lulus">
          <button class="inline-block p-4 border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300">Keterangan Lulus</button>
        </li>
        <li class="mr-2" data-tab="laporan-hasil-studi">
          <button class="inline-block p-4 border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300">Laporan Hasil Studi</button>
        </li>
        <li class="mr-2" data-tab="pengantar-matkul">
          <button class="inline-block p-4 border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300">Pengantar Mata Kuliah</button>
        </li>
      </ul>
    </div>
