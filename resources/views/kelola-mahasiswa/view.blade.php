    ...
    <div class="max-w-md mx-auto">
        <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-indigo-600 px-6 py-8 text-center">
                <div class="mx-auto h-24 w-24 rounded-full bg-white shadow-md overflow-hidden border-4 border-white mb-4">
                ...
                <span class="inline-block mt-2 px-3 py-1 rounded-full text-xs font-semibold 
                          {{ $mahasiswa->status === 'Aktif' ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800' }}">
                    {{ $mahasiswa->status }}
                </span>
            </div>
            ...
            <div class="px-6 py-5">
                ...
                <div class="mt-8 flex space-x-3">
                    <a href="{{ url()->previous() }}" class="flex-1 bg-white hover:bg-gray-100 text-gray-800 py-2 px-4 border border-gray-300 rounded-lg transition duration-200 flex items-center justify-center">
                        <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                        </svg>
                        Kembali
                    </a>
                    <button class="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center">
                        <svg class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
