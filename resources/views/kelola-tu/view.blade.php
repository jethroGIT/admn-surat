...
@section('title', 'Profil Tata Usaha')
            ...
            <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-indigo-600 px-6 py-8 text-center">
                    <div
                        ...
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($tu->nama) }}&background=random&color=fff&size=128"
                            alt="{{ $tu->nama }}" class="h-full w-full object-cover">
                    </div>
                    <h1 class="text-2xl font-bold text-white">{{ $tu->nama }}</h1>
                    <p class="text-indigo-200 mt-1">{{ $tu->prodi->nama_prodi ?? 'Belum memiliki program studi' }}</p>
                    <span class="inline-block mt-2 px-3 py-1 rounded-full text-xs font-semibold 
                        {{ $tu->status === 'Aktif' ? 'bg-green-100 text-green-800' : 
                           ($tu->status === 'Tidak Aktif' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800') }}">
                        {{ $tu->status }}
                    </span>
                </div>
                ...
                <div class="px-6 py-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $tu->username }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $tu->email }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $tu->no_tlp }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-sm font-semibold text-gray-900">{{ $tu->alamat }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                        ...
                        <a href="{{ route('editUser', ['tipe' => 'tu', 'username' => $tu->username]) }}"
